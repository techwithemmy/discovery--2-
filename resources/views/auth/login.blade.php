...
<head>
   ...
   <meta name="theme-color" content="#007cc5">
    <!--title-->
    <title>Login | Vestassets | Bitcoin Investment And Cryptocurrency Trade  | Vestassets | Bitcoin Investment | Cryptocurrency Investment | Etherium Investment</title>
...
@if(Session::has('message'))
        ...
        @endif
                            <!--login form-->
                            <form class="login-signup-form" method="post" action="{{ route('login') }}" method="post">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group input-group-merge">
                                        ...
                                        <input type="password" name="password" class="form-control" placeholder="Enter Password" id="password" name="password" required>
                                    </div>
                                </div>
