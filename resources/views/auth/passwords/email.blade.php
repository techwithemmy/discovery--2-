...
<!-- Mirrored from bluegateinvestments.com/login.php by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 26 Oct 2021 21:56:51 GMT -->
...
<head>
   ...
   <meta name="theme-color" content="#007cc5">
    <!--title-->
    <title>Reset Password | Vestassets | Bitcoin Investment And Cryptocurrency Trade  | Vestassets | Bitcoin Investment | Cryptocurrency Investment | Etherium Investment</title>
...
<div class="main">
    ...
    <section class="hero-section gradient-overlay ptb-100 full-screen" style="background: url('https://stockprudential.org/assets/miner/img/blog/rig.jpg')no-repeat center center / cover">
        <div class="container">
...
<script type="text/javascript" src="http://translate.google.com/translate_a/element.js?cb=googleTranslateElementInit"></script>
                                <h5 class="h3">Reset Password</h5>
                                <p class="text-muted mb-0">Enter your Email to continue.</p>
                            </div>
 ...
 @if (session('status'))
                        ...
                        @endif
                            <!--login form-->
                            <form class="login-signup-form" method="post" action="{{ route('password.email') }}" method="post">
                                ...
                                {{csrf_field()}}
                                    ...
                                    <div class="input-group input-group-merge">
                                        ...
                                        <input type="text" class="form-control" placeholder="Enter your email..." id="email" type="email" class="form-control" name="email" value="{{ old('email') }}" required>
