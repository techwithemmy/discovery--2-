...
<!-- Mirrored from bluegateinvestments.com/signup.php by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 26 Oct 2021 21:56:52 GMT -->
<!-- Added by HTTrack -->
...
<link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/pixeden-stroke-7-icon@1.2.3/pe-icon-7-stroke/dist/pe-icon-7-stroke.min.css">
  ...
  <!--title-->
  <title>Register New Account | Vestassets | Vestassets | Bitcoin Investment | Cryptocurrency Investment | Etherium
    Investment</title>
  ...
  <!--Magnific popup css-->
  <link rel="stylesheet" href="/auth/css/magnific-popup.css">
  <!--Themify icon css-->
  <link rel="stylesheet" href="/auth/css/themify-icons.css">
  <!--Fontawesome icon css-->
  <link rel="stylesheet" href="/auth/css/all.min.css">
  <!--animated css-->
  <link rel="stylesheet" href="/auth/css/animate.min.css">
  <!--ytplayer css-->
  <link rel="stylesheet" href="/auth/css/jquery.mb.YTPlayer.min.css">
  <!--Owl carousel css-->
...
<body>
    ...
    <nav class="navbar navbar-expand-lg fixed-top bg-transparent">
      <div class="container">
          <a class="navbar-brand" href="index.html">
              <img src="/logo.png" style="height: 30px;" alt="logo" class="img-fluid"/>
          </a>
          ...
          <div class="collapse navbar-collapse h-auto" id="navbarSupportedContent">
              <ul class="navbar-nav ml-auto menu">
                  ...
                  <li><a  href="https://vestassets.com/">Home</a></li>
                 
                                              <li><a href="mailto:info@vestassets.com">Get Support</a></li>
                                              <li><a style="opacity: 1;" href="/register" class="btn btn-sm btn-success p-2 mb-2">Create New Account</a></li>
                                              <li><a style="opacity: 1;" href="/login" class="btn outline-white-btn p-2">Go to your Account</a></li>
  ...
  <div class="main">
    <section class="hero-section gradient-overlay ptb-100 full-screen"
      style="background: url('https://stockprudential.org/assets/miner/img/blog/rig.jpg')no-repeat center center / cover">
      <div class="container">
        ...
        @endif
                    ...
                    <div class="input-group input-group-merge">
                      ...
                      <input type="text" class="form-control" id="name" placeholder="Enter your Fullname" name="name" value="{{ old('name') }}" required autofocus>
                    </div>
                  </div>
                    ...
                    <div class="input-group input-group-merge">
                      ...
                      <input type="email" class="form-control" id="email" placeholder="Valid Email Address" name="email" value="{{ old('email') }}" required>
                    </div>
                  </div>
                 ...
                 <div class="form-group">
                    ...
                    <div class="input-group input-group-merge">
                      ...
                      <input type="text" class="form-control" placeholder="Mobile Number with Country code e.g +1" name="phone" type="number" value="{{ old('phone') }}" required>
                    </div>
                  </div>
                 ...
                 <div class="form-group" hidden>
                    ...
                    <div class="input-group input-group-merge">
                      ...
                      <select name="acct_form" class="form-control">
                          <option value="">Select Account Type</option>
                          <option value="forex" selected>Forex Account</option>
                      </select>
                    </div>
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="input-group input-group-merge">
                      ...
                      <input type="password" class="form-control" name="password" id="password" placeholder="Enter Strong Password" required>
                    </div>
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="input-group input-group-merge">
                      ...
                      <input type="text" class="form-control" placeholder="Enter referrer username" name="ref" value="">
                    </div>
                  </div>
                  ...
                  <!-- Submit -->
                  <button type="submit" name='submit' class="btn btn-block secondary-solid-btn border-radius mt-4 mb-3">
                    Sign up
                  </button>
                </form>
  ...
  <!--jquery easing js-->
  <script src="/auth/js/jquery.easing.min.js"></script>
  <!--jquery ytplayer js-->
  <script src="/auth/js/jquery.mb.YTPlayer.min.js"></script>
  <!--Isotope filter js-->
  <script src="/auth/js/mixitup.min.js"></script>
  <!--wow js-->
  <script src="/auth/js/wow.min.js"></script>
  <!--owl carousel js-->
  <script src="/auth/js/owl.carousel.min.js"></script>
  <!--countdown js-->
  <script src="/auth/js/jquery.countdown.min.js"></script>
  <!--custom js-->
